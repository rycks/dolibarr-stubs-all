...
class TemporaryFileFilterPlugin extends \Sabre\DAV\ServerPlugin
{
     ...
     * @return bool
     */
    public function beforeCreateFile($uri, $data, \Sabre\DAV\ICollection $parent, $modified)
    {
    }
    /**
     ...
     * @return bool
     */
    public function httpGet(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $hR, $tempLocation)
    {
    }
    /**
     ...
     * @return bool
     */
    public function httpPut(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $hR, $tempLocation)
    {
    }
    /**
     ...
     * @return bool
     */
    public function httpDelete(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $hR, $tempLocation)
    {
    }
    /**
     ...
     * @return bool
     */
    public function httpPropfind(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $hR, $tempLocation)
    {
    }
    /**
