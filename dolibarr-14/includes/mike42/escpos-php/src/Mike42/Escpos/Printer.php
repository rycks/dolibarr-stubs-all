...
class Printer
{
     ...
     */
    public function barcode($content, $type = \Mike42\Escpos\Printer::BARCODE_CODE39)
    {
    }
    /**
     ...
     */
    public function bitImage(\Mike42\Escpos\EscposImage $img, $size = \Mike42\Escpos\Printer::IMG_DEFAULT)
    {
    }
    /**
     ...
     *  `Printer::IMG_DOUBLE_WIDTH` flags.
     */
    public function bitImageColumnFormat(\Mike42\Escpos\EscposImage $img, $size = \Mike42\Escpos\Printer::IMG_DEFAULT)
    {
    }
    /**
     ...
     *  `Printer::IMG_DOUBLE_WIDTH` flags.
     */
    public function graphics(\Mike42\Escpos\EscposImage $img, $size = \Mike42\Escpos\Printer::IMG_DEFAULT)
    {
    }
    /**
     ...
     */
    public function pdf417Code($content, $width = 3, $heightMultiplier = 3, $dataColumnCount = 0, $ec = 0.1, $options = \Mike42\Escpos\Printer::PDF417_STANDARD)
    {
    }
    /**
     ...
     */
    public function qrCode($content, $ec = \Mike42\Escpos\Printer::QR_ECLEVEL_L, $size = 3, $model = \Mike42\Escpos\Printer::QR_MODEL_2)
    {
    }
    /**
     ...
     */
    public function selectPrintMode($mode = \Mike42\Escpos\Printer::MODE_FONT_A)
    {
    }
    /**
     * Set barcode height.
     ...
     */
    public function setBarcodeTextPosition($position = \Mike42\Escpos\Printer::BARCODE_TEXT_NONE)
    {
    }
    /**
     ...
     */
    public function setColor($color = \Mike42\Escpos\Printer::COLOR_1)
    {
    }
    /**
     ...
     */
    public function setFont($font = \Mike42\Escpos\Printer::FONT_A)
    {
    }
    /**
     ...
     */
    public function setJustification($justification = \Mike42\Escpos\Printer::JUSTIFY_LEFT)
    {
    }
    /**
     ...
     */
    public function setUnderline($underline = \Mike42\Escpos\Printer::UNDERLINE_SINGLE)
    {
    }
    /**
