...
class Xlsx extends \PhpOffice\PhpSpreadsheet\Reader\BaseReader
{
     ...
     */
    private function setColumnAttributes(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $docSheet, $column, array $columnAttributes)
    {
    }
    /**
     ...
     */
    private function setRowAttributes(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $docSheet, $row, array $rowAttributes)
    {
    }
    /**
     ...
     * @param Worksheet $docSheet
     */
    private function readColumnsAndRowsAttributes(\SimpleXMLElement $xmlSheet, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $docSheet)
    {
    }
}