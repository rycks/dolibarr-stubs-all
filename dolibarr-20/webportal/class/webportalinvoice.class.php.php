...
class WebPortalInvoice extends \Facture
{
     ...
     */
    const ARRAY_STATUS_LABEL = array(\Facture::STATUS_DRAFT => 'BillShortStatusDraft', \Facture::STATUS_VALIDATED => 'BillShortStatusNotPaid', \Facture::STATUS_CLOSED => 'BillShortStatusPaid', \Facture::STATUS_ABANDONED => 'BillShortStatusCanceled');
    /**
     * @var Facture Invoice for static methods
     */
    protected $invoice_static = \null;
    /**
     *  'type' field format:
