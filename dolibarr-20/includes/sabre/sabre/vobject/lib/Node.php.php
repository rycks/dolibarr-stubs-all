 ...
 */
abstract class Node implements \IteratorAggregate, \ArrayAccess, \Countable, \JsonSerializable, \Sabre\Xml\XmlSerializable
{
    /**
     ...
     */
    public abstract function xmlSerialize(\Sabre\Xml\Writer $writer) : void;
    /**
     ...
     */
    public function setIterator(\Sabre\VObject\ElementList $iterator)
    {
    }
    /**
