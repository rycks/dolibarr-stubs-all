...
class Plugin extends \Sabre\DAV\ServerPlugin
{
     ...
     */
    public function __construct(\Sabre\DAV\Auth\Backend\BackendInterface $authBackend = null)
    {
    }
    /**
     * Adds an authentication backend to the plugin.
     */
    public function addBackend(\Sabre\DAV\Auth\Backend\BackendInterface $authBackend)
    {
    }
    /**
