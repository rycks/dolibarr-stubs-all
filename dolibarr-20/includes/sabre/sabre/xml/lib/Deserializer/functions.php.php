 ...
 */
function keyValue(\Sabre\Xml\Reader $reader, string $namespace = null) : array
{
}
/**
 ...
 * @return string[]
 */
function enum(\Sabre\Xml\Reader $reader, string $namespace = null) : array
{
}
/**
 ...
 * @return object
 */
function valueObject(\Sabre\Xml\Reader $reader, string $className, string $namespace)
{
}
/**
 ...
 */
function repeatingElements(\Sabre\Xml\Reader $reader, string $childElementName) : array
{
}
/**
 ...
 */
function mixedContent(\Sabre\Xml\Reader $reader) : array
{
}
/**
 ...
 * @return mixed
 */
function functionCaller(\Sabre\Xml\Reader $reader, callable $func, string $namespace)
{
}