...
class Plugin extends \Sabre\DAV\ServerPlugin
{
     ...
     */
    public function httpPatch(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $response)
    {
    }
    /**
     ...
     * @return array|null
     */
    public function getHTTPUpdateRange(\Sabre\HTTP\RequestInterface $request)
    {
    }
}