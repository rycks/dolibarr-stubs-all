...
trait Options
{
     ...
     * @var int|string
     */
    protected static $weekStartsAt = \Carbon\CarbonInterface::MONDAY;
    /**
     * Last day of week.
     *
     * @var int|string
     */
    protected static $weekEndsAt = \Carbon\CarbonInterface::SUNDAY;
    /**
     * Days of weekend.
     *
     * @var array
     */
    protected static $weekendDays = [\Carbon\CarbonInterface::SATURDAY, \Carbon\CarbonInterface::SUNDAY];
    /**
