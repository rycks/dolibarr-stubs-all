...
class Mo extends \CommonObject
{
     ...
     * @return int             <0 if KO, >0 if OK
     */
    public function createProduction(\User $user, $notrigger = \true)
    {
    }
    /**
