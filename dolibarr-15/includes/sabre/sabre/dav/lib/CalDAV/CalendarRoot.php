...
class CalendarRoot extends \Sabre\DAVACL\AbstractPrincipalCollection
{
     ...
     */
    function __construct(\Sabre\DAVACL\PrincipalBackend\BackendInterface $principalBackend, \Sabre\CalDAV\Backend\BackendInterface $caldavBackend, $principalPrefix = 'principals')
    {
    }
    /**
