 ...
 */
abstract class AbstractPrincipalCollection extends \Sabre\DAV\Collection implements \Sabre\DAVACL\IPrincipalCollection
{
    /**
     * Principal backend.
     *
     ...
     */
    public function __construct(\Sabre\DAVACL\PrincipalBackend\BackendInterface $principalBackend, $principalPrefix = 'principals')
    {
    }
    /**
