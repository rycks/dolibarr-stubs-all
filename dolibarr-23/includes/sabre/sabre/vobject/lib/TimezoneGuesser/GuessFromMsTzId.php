...
class GuessFromMsTzId implements \Sabre\VObject\TimezoneGuesser\TimezoneGuesser
{
    /**
    ...
    public function guess(\Sabre\VObject\Component\VTimeZone $vtimezone, bool $throwIfUnsure = false) : ?\DateTimeZone
    {
    }
}