...
class Swift_Mime_Headers_MailboxHeader extends \Swift_Mime_Headers_AbstractHeader
{
     ...
     */
    public function __construct($name, \Swift_Mime_HeaderEncoder $encoder, \Egulias\EmailValidator\EmailValidator $emailValidator, \Swift_AddressEncoder $addressEncoder = \null)
    {
    }
    /**
