...
$search_all = \trim(\GETPOST('search_all', 'alphanohtml'));
$search = array();
$fieldstosearchall = array('t.ref' => "Ref");
...
$htmlofselectarray = $form->multiSelectArrayWithCheckbox('selectedfields', $arrayfields, $varpage, (string) $conf->main_checkbox_left_column ? 'left' : '');
