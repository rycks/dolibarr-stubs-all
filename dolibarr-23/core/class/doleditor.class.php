...
class DolEditor
{
     ...
     */
    public function __construct($htmlname, $content, $width = '', $height = 200, $toolbarname = 'Basic', $notused = '', $toolbarstartexpanded = \false, $uselocalbrowser = -1, $okforextendededitor = \true, $rows = 0, $cols = '', $readonly = 0, $poscursor = array())
    {
    }
