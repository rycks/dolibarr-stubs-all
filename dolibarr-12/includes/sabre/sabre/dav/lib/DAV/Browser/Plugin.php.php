...
class Plugin extends \Sabre\DAV\ServerPlugin
{
     ...
     * @return bool
     */
    function httpGetEarly(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $response)
    {
    }
    /**
     ...
     * @return void
     */
    function htmlActionsPanel(\Sabre\DAV\INode $node, &$output, $path)
    {
    }
    /**
