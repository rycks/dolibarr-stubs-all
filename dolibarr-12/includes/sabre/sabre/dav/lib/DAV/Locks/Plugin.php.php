...
class Plugin extends \Sabre\DAV\ServerPlugin
{
     ...
     */
    function __construct(\Sabre\DAV\Locks\Backend\BackendInterface $locksBackend)
    {
    }
    /**
     ...
     * @return bool
     */
    function httpLock(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $response)
    {
    }
    /**
     * Unlocks a uri
     ...
     * @return void
     */
    function httpUnlock(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $response)
    {
    }
    /**
     ...
     * @return bool
     */
    function lockNode($uri, \Sabre\DAV\Locks\LockInfo $lockInfo)
    {
    }
    /**
     * Unlocks a uri
     ...
     * @return bool
     */
    function unlockNode($uri, \Sabre\DAV\Locks\LockInfo $lockInfo)
    {
    }
    /**
