 ...
 */
class Server extends \Sabre\Event\EventEmitter implements \Psr\Log\LoggerAwareInterface
{
     ...
     * @return void
     */
    function addPlugin(\Sabre\DAV\ServerPlugin $plugin)
    {
    }
    /**
     ...
     * @return void
     */
    function invokeMethod(\Sabre\HTTP\RequestInterface $request, \Sabre\HTTP\ResponseInterface $response, $sendResponse = true)
    {
    }
     ...
     * @return array
     */
    function getCopyAndMoveInfo(\Sabre\HTTP\RequestInterface $request)
    {
    }
    /**
     ...
     * @return bool
     */
    function getPropertiesByNode(\Sabre\DAV\PropFind $propFind, \Sabre\DAV\INode $node)
    {
    }
    /**
     ...
     * @return array|null
     */
    function createCollection($uri, \Sabre\DAV\MkCol $mkCol)
    {
    }
    /**
     ...
     * @return array
     */
    function getIfConditions(\Sabre\HTTP\RequestInterface $request)
    {
    }
    /**
     ...
     * @return array
     */
    function getResourceTypeForNode(\Sabre\DAV\INode $node)
    {
    }
    // }}}
    // {{{ XML Readers & Writers
