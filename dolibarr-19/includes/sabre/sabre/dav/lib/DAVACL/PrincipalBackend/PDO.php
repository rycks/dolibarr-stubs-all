 ...
 */
class PDO extends \Sabre\DAVACL\PrincipalBackend\AbstractBackend implements \Sabre\DAVACL\PrincipalBackend\CreatePrincipalSupport
{
    /**
     ...
     * @param string $path
     */
    public function createPrincipal($path, \Sabre\DAV\MkCol $mkCol)
    {
    }
}